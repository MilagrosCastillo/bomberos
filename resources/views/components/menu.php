        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="dashboard.php" class="<?= $currentpage == 'dashboard.php' ? 'bg-red-950 text-white' : 'text-gray-300' ?> rounded-md  px-3 py-2 text-sm font-medium hover:bg-red-900 hover:text-white" aria-current="page"><i class="fa-solid fa-house mr-0.5"></i> Inicio</a>
              <a href="agregar.php" class="<?= $currentpage == 'agregar.php' ? 'bg-red-950 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-red-900 hover:text-white"><i class="fa-solid fa-square-plus mr-1"></i>Nuevo Registro</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
