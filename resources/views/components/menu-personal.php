        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="<?= BASE_URL?>resources/views/auth/inicio.php" class="<?= $currentpage == 'inicio.php' ? 'bg-red-950 text-white' : 'text-gray-300' ?> rounded-md  px-3 py-2 text-sm font-medium hover:bg-red-900 hover:text-white" aria-current="page"><i class="fa-solid fa-house mr-0.5"></i> Inicio</a>
              <a href="<?= BASE_URL?>resources/views/auth/editar.php" class="<?= $currentpage == 'editar.php' ? 'bg-red-950 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-red-900 hover:text-white"><i class="fa-solid fa-user-pen mr-1"></i>Datos Medicos</a>
              <a href="<?= BASE_URL?>resources/views/auth/familiar.php" class="<?= $currentpage == 'familiar.php' ? 'bg-red-950 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-red-900 hover:text-white"><i class="fa-solid fa-user-pen mr-1"></i>Carga Familiar</a>
              <a href="<?= BASE_URL?>resources/views/auth/credencial.php" class="<?= $currentpage == 'credencial.php' ? 'bg-red-950 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-red-900 hover:text-white"><i class="fa-solid fa-user-pen mr-1"></i>Credenciales</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
